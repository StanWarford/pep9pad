...
class CPUFSMasterController: UITableViewController {
    // MARK: - Internal Variables
    internal var detail: CPUFSDetailController!
    internal var asmDetail: CPUDetailController!
    ...
    override func viewDidLoad() {
        ...
        detail = navController.viewControllers[0] as! CPUFSDetailController
        names = p9FileSystem.loadProjectNames()
    }
    
    func setup(asmDetailVC: CPUDetailController) {
