...
public class CPU1ByteRenderer : NSObject {
    ...
    public dynamic class func drawIpad(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 840, height: 1024), resizing: ResizingBehavior = .aspectFit) {
        ...
        let mDRCkArrowColor = UIColor(red: 0.482, green: 0.268, blue: 0.268, alpha: 1.000)
        let aMUXArrowColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let mDRMuxArrowColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)
        ...
        let memWriteColor = UIColor(red: 0.889, green: 0.373, blue: 0.373, alpha: 1.000)
        ...
        let bustoMDRMuxColor = UIColor(red: 0.000, green: 0.840, blue: 1.000, alpha: 1.000)
