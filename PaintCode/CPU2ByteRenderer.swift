...
public class CPU2ByteRenderer : NSObject {
    ...
    public dynamic class func drawIpad(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 1068, height: 1401), resizing: ResizingBehavior = .aspectFit) {
        ...
        //// Color Declarations
        let registerBankColor = UIColor(red: 0.764, green: 0.706, blue: 0.762, alpha: 1.000)
        let bitsBoxColor = UIColor(red: 0.851, green: 0.802, blue: 0.759, alpha: 1.000)
        let aLUColor = UIColor(red: 0.615, green: 0.975, blue: 1.000, alpha: 1.000)
        ...
        let mWhite = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000)
        let loadCkArrowColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let cArrowColor = UIColor(red: 1.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let bArrowColor = UIColor(red: 0.000, green: 0.003, blue: 1.000, alpha: 1.000)
        let aArrowColor = UIColor(red: 0.303, green: 0.430, blue: 0.273, alpha: 1.000)
        let bBusPipeColor = UIColor(red: 1.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let aBusPipeColor = UIColor(red: 1.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let cBusPipeColor = UIColor(red: 1.000, green: 0.963, blue: 0.585, alpha: 1.000)
        let mARCkArrowColor = UIColor(red: 0.709, green: 0.709, blue: 0.709, alpha: 1.000)
        let mDROCkArrowColor = UIColor(red: 0.482, green: 0.268, blue: 0.268, alpha: 1.000)
        let aMUXArrowColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let mDROMuxArrowColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let cMuxArrowColor = UIColor(red: 0.565, green: 0.905, blue: 0.741, alpha: 1.000)
        let aMuxComboColor = UIColor(red: 1.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let aLULArrowsColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let cBitArrowColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let vBitArrowColor = UIColor(red: 0.493, green: 0.493, blue: 0.493, alpha: 1.000)
        let zBitArrowColor = UIColor(red: 1.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let nBitArrowColor = UIColor(red: 0.104, green: 0.282, blue: 0.601, alpha: 1.000)
        let memWriteArrowColor = UIColor(red: 0.050, green: 0.405, blue: 0.483, alpha: 1.000)
        let memReadArrowColor = UIColor(red: 0.454, green: 0.114, blue: 0.114, alpha: 1.000)
        let cSMuxInArrowColor = UIColor(red: 1.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let sCkArrowColor = UIColor(red: 1.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let cCkArrowInColor = UIColor(red: 0.096, green: 0.193, blue: 0.564, alpha: 1.000)
        let vCkArrowColor = UIColor(red: 1.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let andZArrowInColor = UIColor(red: 0.639, green: 0.230, blue: 0.724, alpha: 1.000)
        let nCkArrowColor = UIColor(red: 1.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let andZArrowOutColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let mARBColor = UIColor(red: 0.000, green: 0.287, blue: 1.000, alpha: 1.000)
        let mARAColor = UIColor(red: 0.037, green: 1.000, blue: 0.000, alpha: 1.000)
        let mARArrowColor = UIColor(red: 0.345, green: 0.596, blue: 0.849, alpha: 1.000)
        let systemBusColor = UIColor(red: 0.413, green: 0.722, blue: 0.296, alpha: 1.000)
        let mDROddArrowColor = UIColor(red: 0.593, green: 0.426, blue: 0.426, alpha: 1.000)
        let mDRCktoAMuxColor = UIColor(red: 0.583, green: 0.644, blue: 0.361, alpha: 1.000)
        let mDRMuxColor = UIColor(red: 0.758, green: 0.564, blue: 0.789, alpha: 1.000)
        let bustoMDROMuxColor = UIColor(red: 0.000, green: 0.840, blue: 1.000, alpha: 1.000)
        let aLUtoCMuxColor = UIColor(red: 0.528, green: 0.350, blue: 0.913, alpha: 1.000)
        let cSMuxColor = UIColor(red: 0.672, green: 0.599, blue: 0.599, alpha: 1.000)
        let bitstoCMuxColor = UIColor(red: 0.048, green: 1.000, blue: 0.000, alpha: 1.000)
        let checkBoxFill = UIColor(red: 0.920, green: 0.920, blue: 0.920, alpha: 1.000)
        let mARMuxColor = UIColor(red: 0.530, green: 0.239, blue: 0.239, alpha: 1.000)
        let mARMuxArrowColor = UIColor(red: 0.430, green: 0.735, blue: 0.609, alpha: 1.000)
        let eOMuxColor = UIColor(red: 0.462, green: 0.605, blue: 0.410, alpha: 1.000)
        let mDROddColor = UIColor(red: 0.621, green: 0.385, blue: 0.385, alpha: 1.000)
        let mDROddConnectorColor = UIColor(red: 1.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let bustoMDREMux = UIColor(red: 1.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let mDREMuxColor = UIColor(red: 1.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let mDREvenColor = UIColor(red: 0.703, green: 0.501, blue: 0.501, alpha: 1.000)
        let mDREvenArrowColor = UIColor(red: 1.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let mDREvenConnectorColor = UIColor(red: 1.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let mDREMuxArrowColor = UIColor(red: 0.000, green: 1.000, blue: 0.914, alpha: 1.000)
        let mDRECkArrowColor = UIColor(red: 0.366, green: 0.461, blue: 0.740, alpha: 1.000)
        let mARMuxArrowLineColor = UIColor(red: 0.379, green: 0.567, blue: 0.916, alpha: 1.000)
        let eOMuxArrowColor = UIColor(red: 0.511, green: 0.583, blue: 0.670, alpha: 1.000)
